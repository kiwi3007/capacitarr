...
| Category | Count |
|----------|-------|
| Total scan rules tested | 118 |
| **PASS** | 118 |
| **WARN** | 1 |
| **FAIL** | 0 |

Of the 118 rules, 53 are active scan rules (attack simulation) and 65 are passive scan rules (observation-based analysis).
...
## Comparison with Previous Scan (2026-03-16)

| Metric | 2026-03-16 | 2026-03-23 | Change |
|--------|-----------|-----------|--------|
| Rules tested | 119 | 118 | -1 (minor ZAP rule set variation) |
| PASS | 119 | 118 | -1 |
| WARN | 1 | 1 | No change |
| FAIL | 0 | 0 | No change |
| Content-Type WARN instances | 14 | 14 | No change |

No new vulnerabilities, regressions, or security findings since the previous baseline.
